 ...
 * and progression library button.
 */
...
export default function ControlPanel({
  ...
  function handleLibrarySelect(chordsString, name) {
    setInputValue(chordsString);
    handleInput(chordsString);
  }
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg
                         bg-jazz-card border border-jazz-border text-jazz-muted
                         hover:text-jazz-accent hover:border-jazz-accent transition-colors"
            >
              <Library size={12} />
              Bibliothèque
            </button>
      ...
      {/* ── Library modal (portal-like, rendered inside this component) ── */}
      {libraryOpen && (
        <ProgressionLibrary
